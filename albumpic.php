...
{
$query3="select distinct * from im where id='$k' && iname='$filename' && ialbum='$z'";
...
<div class="Table">
 <div class="Heading">
        <div class="Cell">
            <p><a href='<?php echo $filename; ?>' data-lightbox="image-1" data-title="My caption"><img src='<? echo $filename; ?>' style="box-shadow: 0px 0px 0px 3px #000;" width="150" height="150" /></a>
</p>
        </div>
        <div class="Cell">
            <p>
<?php
echo "<a href='del11.php?fname=$filename'>Delete</a>";
?>
</p>
        </div>
        <div class="Cell">
...
foreach(glob('*'.JPG)as $filename)
{
$query3="select distinct * from im where id='$k' && iname='$filename' && ialbum='$z'";$result3=mysql_query($query3);
while($row=mysql_fetch_array($result3))
{
?>
...
{
?>
<form action='del11.php' method='get' name='fem'>
...
echo "<br>";
echo "<form action='m1.php' method='post' enctype='multipart/form-data'/>";
